...
export default function () {
    ...
    return <>
            ...
            <div className="d-flex flex-column p-3">
                    ...
                    <div className="d-flex">
                        <div className="d-flex position-relative ">
                            ...
                            <div className="btn-upper">
                                <Button btn_style="btn-outline-secondary" icon={<MdChevronLeft size={24} fill="gray" />}></Button>
                                <Button btn_style="btn-outline-secondary" icon={<MdChevronRight size={24} fill="gray" />}></Button>
                            </div>
                        </div>
                    </div>
                </TableRow>
                ...
                <div className="d-flex my-3">
                    <div className="d-flex position-relative w-100">
                        <TableCell title={'Кодировка'} icon={<MdUnfoldMore size={20} fill="#0085FF" />} />
                ...
                <div className="d-flex my-3">
                    <div className="d-flex position-relative w-100">
                        <TableCell title={'H1B-H-6M'} isTextDashed icon={<MdInfo size={20} fill="#0085FF" />} />
                        <TableCell>
                            <Button btn_style="btn-outline-secondary" icon={<MdPictureAsPdf fill="gray" />}></Button>
                            <Button btn_style="btn-outline-secondary" icon={<Md3DRotation fill="gray" />}></Button>
                        </TableCell>
                        <TableCell title={'17 шт.'}></TableCell>
                        <TableCell title={'7685 ₽'}></TableCell>
                        <TableCell >
                            <ButtonCounter text_style={'font-size-16-gray'} counter={1} btn_style="counter-h40"></ButtonCounter>
                            <Button btn_style="btn-primary" icon={<MdShoppingCart size={20} />} />
                        </TableCell>
        ...
        <br />
        <CollapseAntd title={'TableRow'} text={`
           <div className="d-flex flex-column p-3">
